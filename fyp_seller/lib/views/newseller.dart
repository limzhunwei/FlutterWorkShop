...
class _NewSellerState extends State<NewSeller> {
  ...
  String pathAsset = 'assets/images/documentation_logo.png';
  var _image;
  ...
  void _addUser() {
    ...
    String _sellername = _usernameEditingController.text;
    String _selleraddress = _useraddressEditingController.text;
    String _sellerphone= _userphoneEditingController.text;
    String _selleremail = _useremailEditingController.text;
    String _sellerpassword = _userpasswordEditingController.text;
    String base64Image = base64Encode(_image!.readAsBytesSync());
    
    http.post(
        Uri.parse(CONSTANTS.server + "/fyp/php/new_seller.php"),
        body: {
          "name": _sellername,
